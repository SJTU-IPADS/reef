...
__device__ void fused_nn_conv2d_add_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[1];
...
__device__ void fused_nn_conv2d_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ void fused_nn_conv2d_add_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[2];
...
__device__ void fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4){
  float compute[2];
  __shared__ float pad_temp_shared[128];
  __shared__ float placeholder_shared[2048];
  for (int xx_init = 0; xx_init < 2; ++xx_init) {
...
__device__ void fused_nn_max_pool2d_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = -3.402823e+38f;
  for (int dh = 0; dh < 3; ++dh) {
    for (int dw = 0; dw < 3; ++dw) {
      tensor[(0)] = max(tensor[(0)], (((1 <= (((((int)threadIdx.x) >> 4) * 2) + dh)) && (1 <= (((((int)threadIdx.x) & 15) * 2) + dw))) ? placeholder[(((((((((int)blockIdx.x) * 1024) + ((((int)threadIdx.x) >> 4) * 64)) + (dh * 32)) + ((((int)threadIdx.x) & 15) * 2)) + dw) - 33))] : -3.402823e+38f));
    }
  }
...
__device__ void fused_add_nn_relu_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ void fused_nn_conv2d_add_nn_relu_7_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 2))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 3))];
  placeholder_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder1[(((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)))], placeholder_shared[((((int)threadIdx.z) * 128))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 16))], placeholder_shared[(((((int)threadIdx.z) * 128) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 32))], placeholder_shared[(((((int)threadIdx.z) * 128) + 2))], compute[(0)]);
  ...
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 2032))], placeholder_shared[(((((int)threadIdx.z) * 128) + 127))], compute[(0)]);
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 8192))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 8193))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 8194))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 8195))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 8192))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 8193))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 8194))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 8195))];
  placeholder_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 128))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 129))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 130))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 131))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 132))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 133))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 134))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 135))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)))], placeholder_shared[((((int)threadIdx.z) * 128))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 16))], placeholder_shared[(((((int)threadIdx.z) * 128) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 32))], placeholder_shared[(((((int)threadIdx.z) * 128) + 2))], compute[(0)]);
  ...
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 2032))], placeholder_shared[(((((int)threadIdx.z) * 128) + 127))], compute[(0)]);
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 16384))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 16385))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 16386))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 16387))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 16384))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 16385))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 16386))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 16387))];
  placeholder_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 256))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 257))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 258))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 259))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 260))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 261))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 262))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 263))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)))], placeholder_shared[((((int)threadIdx.z) * 128))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 16))], placeholder_shared[(((((int)threadIdx.z) * 128) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 32))], placeholder_shared[(((((int)threadIdx.z) * 128) + 2))], compute[(0)]);
  ...
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 2032))], placeholder_shared[(((((int)threadIdx.z) * 128) + 127))], compute[(0)]);
  __syncthreads();
  pad_temp_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 24576))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 24577))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 24578))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((int)threadIdx.x) >> 1) * 64)) + (((int)blockIdx.y) * 32)) + ((((int)threadIdx.x) & 1) * 16)) + (((int)blockIdx.x) * 4)) + 24579))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 24576))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 24577))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 24578))];
  pad_temp_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder[((((((((((int)threadIdx.z) * 512) + (((int)threadIdx.y) * 128)) + ((((((int)threadIdx.x) * 2) + 1) >> 2) * 64)) + (((int)blockIdx.y) * 32)) + ((((((int)threadIdx.x) * 2) + 1) & 3) * 8)) + (((int)blockIdx.x) * 4)) + 24579))];
  placeholder_shared[((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 384))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 1))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 385))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 2))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 386))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 3))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 387))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 4))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 388))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 5))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 389))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 6))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 390))];
  placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 7))] = placeholder1[((((((((int)blockIdx.z) * 8192) + (((int)threadIdx.z) * 512)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 391))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((((int)threadIdx.y) * 4) + ((int)threadIdx.x)))], placeholder_shared[((((int)threadIdx.z) * 128))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 16))], placeholder_shared[(((((int)threadIdx.z) * 128) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 4) + ((int)threadIdx.x)) + 32))], placeholder_shared[(((((int)threadIdx.z) * 128) + 2))], compute[(0)]);
...
__device__ void fused_nn_conv2d_add_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  float compute[16];
...
__device__ void fused_nn_conv2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ void fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[16];
  __shared__ float pad_temp_shared[1024];
  __shared__ float placeholder_shared[1024];
  compute[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_conv2d_add_nn_relu_8_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2){
  ...
  compute[(0)] = 0.000000e+00f;
  for (int i = 0; i < 23; i++)
    pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + i))] = placeholder[((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + i) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + 1) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + i) % 7)))];
  for (int i = 0; i < 8; i++)
    placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + i))] = placeholder1[((((((((int)blockIdx.z) * 4096) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + i))];
  ...
  __syncthreads();
  for (int i = 0; i < 23; i++) 
    pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + i))] = placeholder[(((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + i) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + i) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + i) % 7)) + 32768))];
  for (int i = 0; i < 8; i++)
    placeholder_shared[(((((((int)threadIdx.z) * 128) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + i))] = placeholder1[((((((((int)blockIdx.z) * 4096) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.y) * 32)) + (((int)threadIdx.x) * 8)) + 128 + i))];
  __syncthreads();
  for (int i = 0; i < 128; i++)
    compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((((int)threadIdx.y) * 14) + (((int)threadIdx.x) * 2)) + 49 * i))], placeholder_shared[(((((int)threadIdx.z) * 128) + i))], compute[(0)]);
  T_relu[(((((((((int)blockIdx.z) * 1024) + (((int)threadIdx.z) * 64)) + (((int)blockIdx.y) * 32)) + (((int)threadIdx.y) * 8)) + (((int)blockIdx.x) * 4)) + ((int)threadIdx.x)))] = max((compute[(0)] + placeholder2[(((((int)blockIdx.z) * 16) + ((int)threadIdx.z)))]), 0.000000e+00f);
...
__device__ void fused_nn_conv2d_add_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 1))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 2))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 3))];
  __syncthreads();
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 256))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 16))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 17))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 18))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 19))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 512))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 32))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 33))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 34))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 35))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 768))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 48))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 49))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 50))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 51))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 1024))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 64))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 65))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 66))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 67))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 1280))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 80))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 81))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 82))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 83))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 1536))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 96))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 97))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 98))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 99))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 1792))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 112))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 113))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 114))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 115))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 2048))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 128))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 129))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 130))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 131))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 2304))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 144))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 145))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 146))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 147))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 2560))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 160))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 161))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 162))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 163))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 2816))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 176))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 177))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 178))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 179))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 3072))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 192))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 193))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 194))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 195))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 3328))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 208))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 209))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 210))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 211))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 3584))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 224))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 225))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 226))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 227))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
  ...
  if ((((int)threadIdx.x) + ((int)threadIdx.z)) < 64) {
    if (((int)threadIdx.x) < 1) {
      pad_temp_shared[((((int)threadIdx.x) + ((int)threadIdx.z)))] = placeholder[(((((((((int)threadIdx.x) + ((int)threadIdx.z)) >> 2) * 16) + (((int)blockIdx.y) * 4)) + ((((int)threadIdx.x) + ((int)threadIdx.z)) & 3)) + 3840))];
    }
  }
  placeholder_shared[(((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 240))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 1))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 241))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 2))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 242))];
  placeholder_shared[((((((int)threadIdx.z) * 16) + (((int)threadIdx.x) * 4)) + 3))] = placeholder1[(((((((int)blockIdx.z) * 16384) + (((int)threadIdx.z) * 256)) + (((int)threadIdx.x) * 4)) + 243))];
  __syncthreads();
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[(((int)threadIdx.x))], placeholder_shared[((((int)threadIdx.z) * 16))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 4))], placeholder_shared[(((((int)threadIdx.z) * 16) + 1))], compute[(0)]);
  compute[(0)] = __ocml_fma_f32(pad_temp_shared[((((int)threadIdx.x) + 8))], placeholder_shared[(((((int)threadIdx.z) * 16) + 2))], compute[(0)]);
...
__device__ void fused_add_nn_relu_2_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ void fused_add_nn_relu_1_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ void fused_add_nn_relu_3_kernel0_device(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ void fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3){
  float compute[1];
  __shared__ float pad_temp_shared[2048];
  __shared__ float placeholder_shared[2048];
  compute[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_conv2d_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
...
__device__ void fused_nn_conv2d_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute){
  float compute_local[1];
  __shared__ float pad_temp_shared[6272];
  __shared__ float placeholder_shared[2048];
  compute_local[(0)] = 0.000000e+00f;
  for (int i = 0; i < 23; i++)
    pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + i))] = placeholder[((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + i) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + i) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + i) % 7)))];
    ...
    if ((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 14)) + (((((int)threadIdx.x) * 25) + 23) / 7)) < 896) {
      if ((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) < 6249) {
        if (((((int)threadIdx.y) * 98) + (((int)threadIdx.x) * 25)) < 369) {
          if (((int)threadIdx.x) < 3) {
            pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + 23))] = placeholder[((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + 23) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + 23) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + 2) % 7)))];
          }
        }
      }
    }
    ...
    if ((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 14)) + (((((int)threadIdx.x) * 25) + 24) / 7)) < 896) {
      if ((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) < 6248) {
        if (((((int)threadIdx.y) * 98) + (((int)threadIdx.x) * 25)) < 368) {
          if (((int)threadIdx.x) < 3) {
            pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + 24))] = placeholder[((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + 24) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + 24) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + 3) % 7)))];
          }
        }
      }
    }
  ...
  if ((((((int)threadIdx.z) * 8) + (((int)threadIdx.y) * 2)) + (((((int)threadIdx.x) * 25) + 23) / 49)) < 128) {
    if ((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 14)) + (((((int)threadIdx.x) * 25) + 23) / 7)) < 896) {
      if ((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) < 6249) {
        if (((((int)threadIdx.y) * 98) + (((int)threadIdx.x) * 25)) < 369) {
          if (((int)threadIdx.x) < 3) {
            pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + 23))] = placeholder[(((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + 23) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + 23) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + 2) % 7)) + 32768))];
          }
        }
      }
    }
  ...
  if ((((((int)threadIdx.z) * 8) + (((int)threadIdx.y) * 2)) + (((((int)threadIdx.x) * 25) + 24) / 49)) < 128) {
    if ((((((int)threadIdx.z) * 56) + (((int)threadIdx.y) * 14)) + (((((int)threadIdx.x) * 25) + 24) / 7)) < 896) {
      if ((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) < 6248) {
        if (((((int)threadIdx.y) * 98) + (((int)threadIdx.x) * 25)) < 368) {
          if (((int)threadIdx.x) < 3) {
            pad_temp_shared[(((((((int)threadIdx.z) * 392) + (((int)threadIdx.y) * 98)) + (((int)threadIdx.x) * 25)) + 24))] = placeholder[(((((((((((int)threadIdx.z) * 2048) + (((int)threadIdx.y) * 512)) + ((((((int)threadIdx.x) * 25) + 24) / 49) * 256)) + (((int)blockIdx.y) * 128)) + (((((((int)threadIdx.x) * 25) + 24) % 49) / 7) * 16)) + (((int)blockIdx.x) * 8)) + (((((int)threadIdx.x) * 25) + 3) % 7)) + 32768))];
          }
        }
      }
    }
...
__device__ void fused_add_14_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
__device__ void fused_nn_conv2d_add_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2){
  if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 1 * 4 >= 4 * 1 * 64) return;
  if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
  float compute[1];
  __shared__ float pad_temp_shared[64];
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 32) return;
    fused_nn_conv2d_add_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_add,(float* __restrict__)placeholder2);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(42))) void fused_nn_conv2d_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 4 * 2 >= 2 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 32) return;
    fused_nn_conv2d_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)compute);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 2 * 1 >= 1 * 2 * 64) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 32) return;
    fused_nn_conv2d_add_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_add,(float* __restrict__)placeholder2);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 2 * 1 >= 1 * 2 * 64) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 32) return;
    fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_relu,(float* __restrict__)placeholder2,(float* __restrict__)placeholder3,(float* __restrict__)placeholder4);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_max_pool2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_max_pool2d_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)T_relu,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 1 * 4 >= 4 * 1 * 32) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 2 * 2 >= 2 * 2 * 8) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 32) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_nn_relu_kernel0_device_wrapper(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 32 + blockIdx.z * 1 * 32 >= 32 * 1 * 1) return;
    fused_add_nn_relu_kernel0_device((float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(29))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_7_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 4) return;
    fused_nn_conv2d_add_3_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_add,(float* __restrict__)placeholder2);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(44))) void fused_nn_conv2d_add_nn_relu_5_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 4 * 2 >= 2 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    ...
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 4) return;
    fused_nn_conv2d_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)compute);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(46))) void fused_nn_conv2d_add_nn_relu_12_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 16 * 1 >= 1 * 16 * 16) return;
    // if (blockIdx.x + blockIdx.y * 8 + blockIdx.z * 2 * 8 >= 8 * 2 * 2) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 4) return;
    fused_nn_conv2d_add_add_nn_relu_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_relu,(float* __restrict__)placeholder2,(float* __restrict__)placeholder3);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_10_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_4_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 4 * 2 >= 2 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_6_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 32) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 4 * 2 >= 2 * 4 * 4) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_8_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 1 * 4 >= 4 * 1 * 64) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
    fused_nn_conv2d_add_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_relu,(float* __restrict__)placeholder2,(float* __restrict__)placeholder3);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 2 * 1 >= 1 * 2 * 32) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 128 + blockIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    fused_add_nn_relu_2_kernel0_device((float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_add_nn_relu_1_kernel0_device((float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 256 + blockIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    fused_add_nn_relu_3_kernel0_device((float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 2 * 2 >= 2 * 2 * 8) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 32) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_9_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 32) return;
    // if (blockIdx.x + blockIdx.y * 4 + blockIdx.z * 8 * 4 >= 4 * 8 * 2) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 32) return;
    fused_nn_conv2d_add_add_nn_relu_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_relu,(float* __restrict__)placeholder2,(float* __restrict__)placeholder3);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 2 * 2 >= 2 * 2 * 8) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 128) return;
    fused_nn_conv2d_3_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)compute);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 32) return;
    fused_nn_conv2d_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)compute);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_batch_flatten_kernel0_device_wrapper(float* __restrict__ tensor, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 8 + blockIdx.z * 1 * 8 >= 8 * 1 * 1) return;
    fused_nn_batch_flatten_kernel0_device((float* __restrict__)tensor,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(45))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_11_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 4 * 4 >= 4 * 4 * 16) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_14_kernel0_device_wrapper(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 48 + blockIdx.z * 1 * 48 >= 48 * 1 * 1) return;
    fused_add_14_kernel0_device((float* __restrict__)T_add,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 1 * 4 >= 4 * 1 * 64) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
    fused_nn_conv2d_add_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)T_add,(float* __restrict__)placeholder2);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  void fused_nn_conv2d_add_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_multiply_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_max_pool2d_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_3_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_add_nn_relu_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_nn_relu_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_nn_relu_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_nn_relu_3_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_add_nn_relu_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_3_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_14_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_conv2d_add_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_1_32(int idx) {
  dim3 dim(1, 1, 32);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_8_2_2(int idx) {
  dim3 dim(8, 2, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_16_16(int idx) {
  dim3 dim(1, 16, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_4_4(int idx) {
  dim3 dim(1, 4, 4);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_1_64(int idx) {
  dim3 dim(4, 1, 64);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_48_1_1(int idx) {
  dim3 dim(48, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_4_16(int idx) {
  dim3 dim(2, 4, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_4_16(int idx) {
  dim3 dim(1, 4, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_2_32(int idx) {
  dim3 dim(1, 2, 32);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_1_8(int idx) {
  dim3 dim(1, 1, 8);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_4_1(int idx) {
  dim3 dim(1, 4, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_1_32(int idx) {
  dim3 dim(4, 1, 32);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_2_8(int idx) {
  dim3 dim(2, 2, 8);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_4_4(int idx) {
  dim3 dim(2, 4, 4);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_8_2(int idx) {
  dim3 dim(4, 8, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_1_16(int idx) {
  dim3 dim(1, 1, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_8_1_1(int idx) {
  dim3 dim(8, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_32_1_1(int idx) {
  dim3 dim(32, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_2_64(int idx) {
  dim3 dim(1, 2, 64);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
__global__ void get_3d_idx_caller(int* buf) {
    ...
    task_idx = get_3d_idx_1_1_32(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_8_2_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_16_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_4_4(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_4_1_64(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_48_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_2_4_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_4_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_1_2_32(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_1_8(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_4_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_4_1_32(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_2_2_8(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_2_4_4(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_4_8_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_1_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_8_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_32_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_1_2_64(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
