...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_2_16(int idx) {
  dim3 dim(14, 2, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_4_8(int idx) {
  dim3 dim(14, 4, 8);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_28_2(int idx) {
  dim3 dim(1, 28, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_1_64(int idx) {
  dim3 dim(14, 1, 64);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_2_64(int idx) {
  dim3 dim(7, 2, 64);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
__global__ void get_3d_idx_caller(int* buf) {
    ...
    task_idx = get_3d_idx_14_2_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_14_4_8(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_1_28_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_14_1_64(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_7_2_64(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
