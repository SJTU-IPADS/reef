...
__device__ void fused_nn_avg_pool2d_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
...
__device__ void fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
...
__device__ void fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1){
  float tensor[1];
  tensor[(0)] = 0.000000e+00f;
  for (int dh = 0; dh < 2; ++dh) {
    for (int dw = 0; dw < 2; ++dw) {
...
__device__ void fused_nn_avg_pool2d_kernel0_device(float* __restrict__ placeholder, float* __restrict__ tensor){
  float tensor1[1];
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 7 * 7 >= 7 * 7 * 8) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 56) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_batch_flatten_kernel0_device_wrapper(float* __restrict__ tensor, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 1 * 1 >= 1 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_8_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    ...
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 7 * 1 >= 1 * 7 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(38))) void fused_nn_conv2d_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 2 + threadIdx.z * 2 * 2 >= 2 * 2 * 1) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 7 * 7 >= 7 * 7 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_10_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 4 * 14 >= 14 * 4 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_11_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 32) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 14 * 7 >= 7 * 14 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_4_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 7 * 7 >= 7 * 7 * 8) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 2) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_avg_pool2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 172 + blockIdx.z * 1 * 172 >= 172 * 1 * 1) return;
    fused_nn_avg_pool2d_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)T_relu,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(47))) void fused_nn_conv2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 7 * 7 >= 7 * 7 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(78))) void fused_nn_conv2d_add_nn_relu_9_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 8 * 7 >= 7 * 8 * 1) return;
    // if (blockIdx.x + blockIdx.y * 8 + blockIdx.z * 7 * 8 >= 8 * 7 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_avg_pool2d_add_nn_relu_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)T_relu,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(29))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_5_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 7 * 7 >= 7 * 7 * 8) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 2 * 2 >= 2 * 2 * 2) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    ...
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 2) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 7 + threadIdx.z * 1 * 7 >= 7 * 1 * 4) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 7 * 1 >= 1 * 7 * 8) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(36))) void fused_nn_conv2d_add_nn_relu_12_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 16 * 4 >= 4 * 16 * 4) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 7 * 2 >= 2 * 7 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 392 + blockIdx.z * 1 * 392 >= 392 * 1 * 1) return;
    fused_nn_avg_pool2d_add_nn_relu_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)T_relu,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_avg_pool2d_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ tensor) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 1 * 1 >= 1 * 1 * 1) return;
    fused_nn_avg_pool2d_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)tensor);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(35))) __attribute__((amdgpu_num_sgpr(72))) void fused_nn_conv2d_add_nn_relu_6_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 4 * 14 >= 14 * 4 * 1) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 7 * 2 >= 2 * 7 * 1) return;
...
extern "C" __global__  void fused_nn_avg_pool2d_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_avg_pool2d_add_nn_relu_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_avg_pool2d_add_nn_relu_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_avg_pool2d_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_7_1(int idx) {
  dim3 dim(2, 7, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_172_1_1(int idx) {
  dim3 dim(172, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_8_1(int idx) {
  dim3 dim(7, 8, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_7_1(int idx) {
  dim3 dim(1, 7, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_1_4(int idx) {
  dim3 dim(7, 1, 4);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_8_7_1(int idx) {
  dim3 dim(8, 7, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_2_56(int idx) {
  dim3 dim(2, 2, 56);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_7_1(int idx) {
  dim3 dim(7, 7, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_16_4(int idx) {
  dim3 dim(4, 16, 4);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_392_1_1(int idx) {
  dim3 dim(392, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_2_2(int idx) {
  dim3 dim(2, 2, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_2_1(int idx) {
  dim3 dim(2, 2, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_7_16(int idx) {
  dim3 dim(2, 7, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_1_2(int idx) {
  dim3 dim(1, 1, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_4_1(int idx) {
  dim3 dim(14, 4, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
__global__ void get_3d_idx_caller(int* buf) {
    ...
    task_idx = get_3d_idx_2_7_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_172_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_7_8_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_1_7_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_7_1_4(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_8_7_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_2_2_56(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_7_7_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_4_16_4(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_392_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_2_2_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_2_2_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_2_7_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_1_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_14_4_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
