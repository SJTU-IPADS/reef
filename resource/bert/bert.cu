...
extern "C" __global__ void fused_nn_softmax_1_kernel0(float* __restrict__ T_softmax_maxelem, float* __restrict__ placeholder) {
...
extern "C" __global__ void fused_nn_softmax_1_kernel1(float* __restrict__ T_softmax_exp, float* __restrict__ placeholder, float* __restrict__ T_softmax_maxelem) {
...
extern "C" __global__ void fused_reshape_add_multiply_erf_multiply_add_multiply_reshape_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_mean_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder_red) {
...
extern "C" __global__ void fused_subtract_add_sqrt_divide_multiply_add_1_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_reshape_5_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
...
extern "C" __global__ void fused_reshape_transpose_copy_reshape_1_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_reshape_add_reshape_transpose_transpose_reshape_transpose_kernel0(float* __restrict__ T_transpose, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_reshape_add_reshape_transpose_divide_reshape_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_full_equal_reshape_kernel0(signed char* __restrict__ T_reshape) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_reshape[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (signed char)0;
  }
}

extern "C" __global__ void fused_cast_take_broadcast_to_like_cast_take_add_1_kernel0(float* __restrict__ T_add, float* __restrict__ placeholder, long* __restrict__ placeholder1, float* __restrict__ placeholder2, long* __restrict__ placeholder3) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
...
extern "C" __global__ void fused_nn_softmax_1_kernel2(float* __restrict__ T_softmax_maxelem, float* __restrict__ T_softmax_exp) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 5760) {
...
extern "C" __global__ void fused_mean_1_kernel1(float* __restrict__ T_divide, float* __restrict__ placeholder_red) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_divide[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (placeholder_red[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] * 2.083333e-03f);
  }
}

extern "C" __global__ void fused_reshape_4_kernel0(float* __restrict__ T_reshape, float* __restrict__ placeholder) {
  for (int ax0_ax1_fused_ax2_fused_outer = 0; ax0_ax1_fused_ax2_fused_outer < 4; ++ax0_ax1_fused_ax2_fused_outer) {
    if ((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 230400) {
      T_reshape[((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)))] = placeholder[((((ax0_ax1_fused_ax2_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)))];
    }
...
extern "C" __global__ void fused_variance_1_kernel0(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_multiply_red) {
...
extern "C" __global__ void fused_variance_1_kernel1(float* __restrict__ T_divide, float* __restrict__ T_multiply_red) {
  if (((((int)blockIdx.x) * 256) + ((int)threadIdx.x)) < 480) {
    T_divide[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] = (T_multiply_red[(((((int)blockIdx.x) * 256) + ((int)threadIdx.x)))] * 2.083333e-03f);
  }
}

extern "C" __global__ void fused_reshape_cast_broadcast_to_like_where_kernel0(float* __restrict__ T_where, signed char* __restrict__ placeholder, float* __restrict__ placeholder1) {
...
extern "C" __global__ void fused_nn_softmax_1_kernel3(float* __restrict__ T_softmax_norm, float* __restrict__ T_softmax_exp, float* __restrict__ T_softmax_maxelem) {
  for (int i0_i1_fused_i2_fused_i3_fused_outer = 0; i0_i1_fused_i2_fused_i3_fused_outer < 43; ++i0_i1_fused_i2_fused_i3_fused_outer) {
    if ((((i0_i1_fused_i2_fused_i3_fused_outer * 65536) + (((int)blockIdx.x) * 256)) + ((int)threadIdx.x)) < 2764800) {
