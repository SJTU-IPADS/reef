...
extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_2_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_add_nn_relu_2_kernel0_device(placeholder, placeholder1, T_relu, placeholder2, placeholder3);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_1_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_add_nn_relu_1_kernel0_device(placeholder, placeholder1, T_relu, placeholder2, placeholder3);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_add_kernel0(int* preempted, int* task_slot, float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_add_kernel0_device(T_add, placeholder, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_4_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_4_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_9_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_9_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_1_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_1_kernel0_device(placeholder, placeholder1, compute);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_5_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_5_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_3_kernel0(int* preempted, int* task_slot, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_add_nn_relu_3_kernel0_device(T_relu, placeholder, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_kernel0_device(placeholder, placeholder1, compute);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_max_pool2d_add_nn_relu_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_nn_max_pool2d_add_nn_relu_kernel0_device(placeholder, T_relu, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_1_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_1_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_1_kernel0(int* preempted, int* task_slot, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_add_nn_relu_1_kernel0_device(T_relu, placeholder, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_dense_add_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_dense_add_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_12_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_12_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_softmax_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ T_softmax_norm) {
    if (*preempted) return;
    tvmgen_default_fused_nn_softmax_kernel0_device(placeholder, T_softmax_norm);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_2_kernel0(int* preempted, int* task_slot, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_add_nn_relu_2_kernel0_device(T_relu, placeholder, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_add_nn_relu_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_add_nn_relu_kernel0_device(placeholder, placeholder1, T_relu, placeholder2, placeholder3);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_7_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_7_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_3_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_3_kernel0_device(placeholder, placeholder1, compute);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_2_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_2_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_8_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_8_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_11_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_11_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_3_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_3_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_10_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_10_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_2_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_2_kernel0_device(placeholder, placeholder1, compute);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_add_nn_relu_kernel0(int* preempted, int* task_slot, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    if (*preempted) return;
    tvmgen_default_fused_add_nn_relu_kernel0_device(T_relu, placeholder, placeholder1);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_3_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_3_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_2_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_2_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_multiply_add_nn_relu_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2, float* __restrict__ placeholder3, float* __restrict__ placeholder4) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_multiply_add_nn_relu_kernel0_device(placeholder, placeholder1, T_relu, placeholder2, placeholder3, placeholder4);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_6_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_6_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_global_avg_pool2d_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ tensor) {
    if (*preempted) return;
    tvmgen_default_fused_nn_global_avg_pool2d_kernel0_device(placeholder, tensor);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_batch_flatten_kernel0(int* preempted, int* task_slot, float* __restrict__ tensor, float* __restrict__ placeholder) {
    if (*preempted) return;
    tvmgen_default_fused_nn_batch_flatten_kernel0_device(tensor, placeholder);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_1_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_add, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_1_kernel0_device(placeholder, placeholder1, T_add, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        

extern "C" __global__ void tvmgen_default_fused_nn_conv2d_add_nn_relu_kernel0(int* preempted, int* task_slot, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    if (*preempted) return;
    tvmgen_default_fused_nn_conv2d_add_nn_relu_kernel0_device(placeholder, placeholder1, T_relu, placeholder2);
    if (threadIdx.x + threadIdx.y + threadIdx.z == 0)
        atomicAdd(task_slot, 1);
}        
