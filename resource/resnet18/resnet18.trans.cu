...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[8];
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[8];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[3136];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[36];
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[16];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 25088))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[36];
  float data_pack_local[36];
  for (int eps = 0; eps < 6; ++eps) {
    for (int nu = 0; nu < 6; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[1568];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[16];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[1024];
  __shared__ float data_pack_shared[256];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 12544))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[2048];
  __shared__ float data_pack_shared[896];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder){
  float inverse[4];
  inverse[(0)] = 0.000000e+00f;
  inverse[(0)] = (inverse[(0)] + bgemm[(((((int)blockIdx.x) * 128) + ((int)threadIdx.x)))]);
  inverse[(0)] = (inverse[(0)] + bgemm[((((((int)blockIdx.x) * 128) + ((int)threadIdx.x)) + 8192))]);
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[2048];
  __shared__ float data_pack_shared[896];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm){
  float bgemm_local[4];
  __shared__ float placeholder_shared[512];
  __shared__ float data_pack_shared[1568];
  bgemm_local[(0)] = 0.000000e+00f;
...
__device__ void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device(float* __restrict__ placeholder, float* __restrict__ data_pack){
  float d[16];
  float data_pack_local[16];
  for (int eps = 0; eps < 4; ++eps) {
    for (int nu = 0; nu < 4; ++nu) {
...
__device__ void fused_add_10_kernel0_device(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1){
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    ...
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    ...
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 98 + threadIdx.z * 8 * 98 >= 98 * 8 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    ...
    if (threadIdx.x + threadIdx.y * 98 + threadIdx.z * 8 * 98 >= 98 * 8 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 8 + threadIdx.z * 32 * 8 >= 8 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 8 * 1 >= 1 * 8 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 98 + threadIdx.z * 8 * 98 >= 98 * 8 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 4 * 1 >= 1 * 4 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(54))) void fused_nn_softmax_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_softmax_norm) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    ...
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 4 + threadIdx.z * 2 * 4 >= 4 * 2 * 64) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 14 * 7 >= 7 * 14 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_add,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_add,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 49 + threadIdx.z * 4 * 49 >= 49 * 4 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 16 * 1 >= 1 * 16 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(63))) void fused_nn_conv2d_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(61))) __attribute__((amdgpu_num_sgpr(65))) void fused_nn_conv2d_add_nn_relu_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 1 * 14 >= 14 * 1 * 32) return;
    // if (blockIdx.x + blockIdx.y * 2 + blockIdx.z * 7 * 2 >= 2 * 7 * 4) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder,(float* __restrict__)placeholder1,(float* __restrict__)placeholder2);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(54))) void fused_nn_conv2d_add_nn_relu_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 8 + threadIdx.z * 32 * 8 >= 8 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 8 * 1 >= 1 * 8 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(42))) void fused_nn_conv2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ T_relu, float* __restrict__ placeholder2) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_relu, float* __restrict__ placeholder) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_relu,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(33))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_add,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(63))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_3_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 1 + threadIdx.z * 1 * 1 >= 1 * 1 * 32) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 7 * 1 >= 1 * 7 * 16) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    ...
    if (threadIdx.x + threadIdx.y * 8 + threadIdx.z * 32 * 8 >= 8 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 8 * 1 >= 1 * 8 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_max_pool2d_add_nn_relu_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ T_relu, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 784 + blockIdx.z * 1 * 784 >= 784 * 1 * 1) return;
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(31))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_conv2d_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ placeholder1, float* __restrict__ compute) {
    // Force the compiler to use all the index
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    ...
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 32 * 14 >= 14 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 1 * 7 >= 7 * 1 * 36) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(27))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device_wrapper(float* __restrict__ bgemm, float* __restrict__ T_add, float* __restrict__ placeholder) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 64 + blockIdx.z * 1 * 64 >= 64 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2_device((float* __restrict__)bgemm,(float* __restrict__)T_add,(float* __restrict__)placeholder);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 14 + threadIdx.z * 32 * 14 >= 14 * 32 * 1) return;
    // if (blockIdx.x + blockIdx.y * 7 + blockIdx.z * 1 * 7 >= 7 * 1 * 36) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(39))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack, float* __restrict__ bgemm) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 49 + threadIdx.z * 4 * 49 >= 49 * 4 * 1) return;
    // if (blockIdx.x + blockIdx.y * 1 + blockIdx.z * 16 * 1 >= 1 * 16 * 16) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1_device((float* __restrict__)placeholder,(float* __restrict__)data_pack,(float* __restrict__)bgemm);
    asm volatile(";; end_flag"); // jump back to the caller
}
...
extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    ...
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 98 + blockIdx.z * 1 * 98 >= 98 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device_wrapper(float* __restrict__ placeholder, float* __restrict__ data_pack) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 128 + threadIdx.z * 1 * 128 >= 128 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 196 + blockIdx.z * 1 * 196 >= 196 * 1 * 1) return;
    fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0_device((float* __restrict__)placeholder,(float* __restrict__)data_pack);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  __attribute__((amdgpu_num_vgpr(25))) __attribute__((amdgpu_num_sgpr(30))) void fused_add_10_kernel0_device_wrapper(float* __restrict__ T_add, float* __restrict__ placeholder, float* __restrict__ placeholder1) {
    // Force the compiler to use all the index
    if (threadIdx.x + threadIdx.y * 256 + threadIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    // if (blockIdx.x + blockIdx.y * 256 + blockIdx.z * 1 * 256 >= 256 * 1 * 1) return;
    fused_add_10_kernel0_device((float* __restrict__)T_add,(float* __restrict__)placeholder,(float* __restrict__)placeholder1);
    asm volatile(";; end_flag"); // jump back to the caller
}

extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel0(
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_2_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_multiply_add_nn_re_11882905421691233276__kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_3_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_add_nn_relu_2_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_kernel2(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_3_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_1_kernel1(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_nn_relu_1_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_nn_contrib_conv2d_winograd_without_weight_transform_add_2_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __global__  void fused_add_10_kernel0(
    void* func_l, int layers_l, int task_num_l, int task_offset_l, float** param_l,
    void* func_r, int layers_r, int task_num_r, int task_offset_r, float** param_r,
    int cu_partition) {
    asm volatile(";; caller_flag");
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_32_1(int idx) {
  dim3 dim(14, 32, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_2_16(int idx) {
  dim3 dim(4, 2, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_8_32_1(int idx) {
  dim3 dim(8, 32, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_98_1_1(int idx) {
  dim3 dim(98, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_28_2(int idx) {
  dim3 dim(7, 28, 2);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_196_1_1(int idx) {
  dim3 dim(196, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_2_7_4(int idx) {
  dim3 dim(2, 7, 4);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_98_8_1(int idx) {
  dim3 dim(98, 8, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_784_1_1(int idx) {
  dim3 dim(784, 1, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_2_64(int idx) {
  dim3 dim(4, 2, 64);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_4_16(int idx) {
  dim3 dim(7, 4, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_49_4_1(int idx) {
  dim3 dim(49, 4, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_1_32(int idx) {
  dim3 dim(7, 1, 32);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_8_16(int idx) {
  dim3 dim(1, 8, 16);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_14_1(int idx) {
  dim3 dim(7, 14, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_4_28_1(int idx) {
  dim3 dim(4, 28, 1);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_1_14_8(int idx) {
  dim3 dim(1, 14, 8);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_7_1_36(int idx) {
  dim3 dim(7, 1, 36);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
extern "C" __device__ __noinline__ dim3 get_3d_idx_14_1_32(int idx) {
  dim3 dim(14, 1, 32);
  dim3 result;
  result.x = idx % dim.x;
  result.y = idx / dim.x % dim.y;
...
__global__ void get_3d_idx_caller(int* buf) {
    ...
    task_idx = get_3d_idx_14_32_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_4_2_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_8_32_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_98_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_7_28_2(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_196_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_2_7_4(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_98_8_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_784_1_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_4_2_64(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_7_4_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_49_4_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_7_1_32(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_8_16(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_7_14_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_4_28_1(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;

    task_idx = get_3d_idx_1_14_8(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_7_1_36(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
    ...
    task_idx = get_3d_idx_14_1_32(threadIdx.x);
    buf[task_idx.x] = task_idx.x;
    buf[task_idx.y] = task_idx.y;
    buf[task_idx.z] = task_idx.z;
